...
const Izdelki = () => {
  ...
  const [newReview, setNewReview] = useState({
    ...
    description: '',
    rating: 0,
    imageData: '' // Dodajanje novega stanja za shranjevanje base64 slike
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addDoc(collection(firestore, 'productReviews'), reviewEntry);
      setProducts([...products, reviewEntry]);
